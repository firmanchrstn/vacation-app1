...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Jelajah Destinasi', style: Theme.of(context).textTheme.titleLarge),
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data!.docs.isEmpty) {
            return Center(child: Text('Destinasi tidak ditemukan.', style: Theme.of(context).textTheme.bodyLarge));
          }
